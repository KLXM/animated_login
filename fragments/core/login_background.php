...
#rex-page-login .panel-default {
    background-color: rgba(50, 64, 80, 0.57);
    border: 0;
    color: #dfe3e9;
    border-radius:10px
}	
...
/*Animation*/
.icon:nth-child(2) img {-webkit-animation-delay: 1.5s;animation-delay: 2.4s}
.icon:nth-child(3) img {-webkit-animation-delay: 1.6s;animation-delay: 3.2s}
.icon:nth-child(4) img {-webkit-animation-delay: 1.8s;animation-delay: 5.4s}
